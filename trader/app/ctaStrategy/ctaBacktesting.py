...
class BacktestingEngine(object):
    ...
    def setStartDate(self, startDate='20100101', initDays=10):
        ...
        print "self.strategyStartDate", self.strategyStartDate
    ...
    def calculateBacktestingResult(self):
        ...
        for trade in self.tradeDict.values():
            ...
            if trade.direction == DIRECTION_LONG:  # 多头交易

                if not shortTrade:  # 如果尚无空头交易
    ...
    def showBacktestingResult(self):
        ...
        tradeTimeIndex = [item.strftime("%Y/%m/%d") for item in d['tradeTimeList']]
...
if __name__ == '__main__':
    ...
    # from strategy.strategyDualThrust import *
    # from strategy.strategyXgg import *
    from strategy.strategyTurtle import *
    # 创建回测引擎
    engine = BacktestingEngine()
    ...
    # 设置回测用的数据起始日期
    engine.setStartDate('20090327', initDays=29)

    # 载入历史数据到引擎中
    engine.setDatabase(DAILY_DB_NAME, 'rb0')
    ...
    # engine.initStrategy(XggStrategy, {})
    engine.initStrategy(TurtleStrategy, {})
