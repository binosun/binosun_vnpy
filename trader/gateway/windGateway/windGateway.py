...
class WindGateway(VtGateway):
    ...
    def subscribe(self, subscribeReq):
        """订阅行情"""
        print"-"*20
        print "subscribeReq",subscribeReq
        print subscribeReq.symbol, type(subscribeReq.symbol)
        print subscribeReq.exchange, type(subscribeReq.exchange)
        print exchangeMap[subscribeReq.exchange]
        print"-"*20
